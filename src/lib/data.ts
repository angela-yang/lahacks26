...
export const MOCK_FEEDBACK: Feedback[] = [
  {
    ...
    summary:
      "The analytics chart overflows on screens smaller than 768px and hides the legend.",
    content:
      "Hi team — just noticed the dashboard analytics chart completely breaks on mobile. The chart overflows past the container edge and the legend disappears. I checked on iPhone 14 and Samsung S23. This is blocking a few of our users from reviewing their weekly stats. Can this be prioritized?",
  ...
  },
  {
    ...
    summary:
      "Users want to download report data as a CSV file for external analysis.",
    content:
      "Could we add a CSV export button to the reports page? Our finance team needs to pull data into Excel for quarterly reviews. Even a simple download of the current table view would be super helpful.",
  ...
  },
  {
    ...
    content:
      "When you click sign in, nothing happens visually for a few seconds. Users think it's broken and click again. Please add a loading spinner or some kind of feedback.",
  ...
  },
  {
    ...
    summary:
      "Update landing page headline and subtext per new brand guidelines.",
    content:
      'New brand guidelines are attached. Please update the hero headline to "Design That Speaks" and replace the subtext with the new value prop copy from the doc.',
